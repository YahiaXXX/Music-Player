...
const TopChartCard=({song,i,isPlaying,activeSong,handlePause,handlePlay})=>(
  <div className=" w-full flex flex-row items-center hover:bg-[#4c426e] py-2 p-4 rounded-lg cursor-pointer mb-2" >
    ...
    <div className=" flex-1 flex justify-between flex-row items-center" >
          <img className=" h-20 w-20 rounded-lg" src={song?.images?.coverart} alt="coverart" />
...
const TopPlay = () => {
  ...
  return(
  <div className="xl:ml-6 ml-0 xl:mb-0 mb-6 xl:max-w-[500px] max-w-full flex-1 flex flex-col" ref={divRef} >
    ...
    <div className="flex flex-row justify-between items-center" >
      ...
      className="mt-4"
       >
        ...
        >
          <Link to={`/artists/${song?.artists[0].adamid}`} >
            <img src={song?.images.background} alt="img" className=" w-full rounded-full object-cover" />
          </Link>
